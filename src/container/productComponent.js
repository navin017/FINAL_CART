...
const popUpSubmit = (e) =>
{
  ...
  <HighlightOffIcon onClick={() => handleConfirm(product.id)} />
)} 
  ...
  function Popup({ productId,handleYes, handleNo }) {
    ...
    const handleDelete = () => {
      handleYes(productId);
		...
		return (
			<div>
				<form className='confirm-form' onSubmit={popUpSubmit}>
					<h3 style={{color:'white'}}>Are you willing to delete Product ?</h3>
					<br></br>
					<div className='btn' >
						<button className='confirm-btn1' onClick={handleDelete}>Yes</button>
